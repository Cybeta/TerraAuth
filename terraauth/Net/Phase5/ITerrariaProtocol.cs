    ...
    int ProtocolId)
{
    ...
    /// 权威来源：本地客户端 <c>本地客户端</c> 原版，
    /// <c>NetMessage</c> 写入 <c>"Terraria" + 326</c>，<c>MessageBuffer</c> 按同串校验。
    /// </summary>
...
public sealed class TerrariaProtocol : ITerrariaProtocol
{
    ...
    public bool RequiresAuthority(PacketId id) => id switch
    {
        PacketId.PlayerPosition or PacketId.NpcStrike or PacketId.ProjectileNew
            ...
            or PacketId.TeleportEntity or PacketId.RequestTeleportationByServer => true,
        _ => false,
    };
